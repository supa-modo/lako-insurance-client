...
const DocumentUpload = ({
  ...
  // Document types configuration based on insurance type
  const getDocumentTypes = () => {
    if (customDocumentTypes) {
      return customDocumentTypes;
    }
    ...
    switch (insuranceType) {
      ...
      case "health":
        return [
          ...
          },
          {
            ...
            required: false,
            description: "Recent medical reports or test results (if any)",
            acceptedFormats: "PDF, JPEG, PNG",
            maxSize: "5MB",
          },
          {
      ...
      case "travel":
        return [
          ...
          {
            id: "travel_itinerary",
            name: "Upload Travel Itinerary",
            required: true,
            description: "Flight tickets or travel booking confirmation",
            acceptedFormats: "PDF, JPEG, PNG",
            maxSize: "5MB",
          },
          {
            id: "visa",
            name: "Upload Visa/Travel Documents",
            required: false,
            description: "Visa copy or other travel documents",
            acceptedFormats: "PDF, JPEG, PNG",
            maxSize: "5MB",
          },
        ];
  ...
  // Get step title based on insurance type
  const getStepTitle = () => {
    switch (insuranceType) {
      case "personal-accident":
