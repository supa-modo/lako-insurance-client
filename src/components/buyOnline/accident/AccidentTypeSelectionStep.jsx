...
import { TbChevronLeft, TbChevronRight, TbInfoCircle, TbCheck } from "react-icons/tb";
import { FaUserInjured, FaPlane, FaBuilding } from "react-icons/fa";
...
const AccidentTypeSelectionStep = ({ formData, updateFormData, nextStep, prevStep }) => {
  ...
  return (
    <div>
      <h2 className="text-xl md:text-2xl font-bold text-primary-600 mb-4">Select Accident Type</h2>
      
      <p className="text-slate-600 text-[0.9rem] md:text-[1.1rem] mb-6">
        Choose the type of accident coverage that best fits your needs. Different accident types offer varying levels of protection.
      </p>
...
export default AccidentTypeSelectionStep;
