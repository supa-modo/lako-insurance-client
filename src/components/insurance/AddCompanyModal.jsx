...
const AddCompanyModal = ({ onClose, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await insuranceService.createCompany(processedData);

      if (response && response.success) {
        onSave(response.data);
        onClose();
      } else {
        setErrors({ submit: response?.message || "Failed to create company" });
      }
    } catch (error) {
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">
                  Create a new insurance company profile
                </p>
              </div>
            </div>
            <button
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-semibold text-neutral-700 mb-4 flex items-center">
                  <TbBuilding size={20} className="mr-2 text-primary-600" />
                  Basic Information
                </h3>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        onChange={handleInputChange}
                        rows="3"
                        className="w-full font-lexend text-[0.93rem] bg-neutral-100 text-neutral-900 pl-10 pr-4 py-2.5 rounded-lg border border-gray-300 focus:ring-1 focus:outline-none focus:ring-primary-500 focus:border-primary-500 transition-colors"
              ...
              <div className="border-t border-gray-200 pt-6">
                <h3 className="font-semibold text-neutral-700 mb-4 flex items-center">
                  <TbStar size={20} className="mr-2 text-primary-600" />
                  Company Rating
                </h3>
