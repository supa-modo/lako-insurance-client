...
const EditPlanModal = ({ plan, companies, onClose, onSave }) => {
  ...
  // Form state - initialize with plan data
  ...
  useEffect(() => {
    if (plan) {
      setFormData({
        ...
        insuranceType: plan.insuranceType || "seniors",
        eligibilityAgeMin: plan.eligibilityAgeMin || "",
        eligibilityAgeMax: plan.eligibilityAgeMax || "",
        inpatientCoverageLimit: plan.inpatientCoverageLimit || "",
        outpatientCoverageLimit: plan.outpatientCoverageLimit || "",
        hasDental: plan.hasDental || false,
        dentalCoverageLimit: plan.dentalCoverageLimit || "",
        dentalPremium: plan.dentalPremium || "",
        dentalCoveredInBase: plan.dentalCoveredInBase || false,
        hasOptical: plan.hasOptical || false,
        opticalCoverageLimit: plan.opticalCoverageLimit || "",
        opticalPremium: plan.opticalPremium || "",
        opticalCoveredInBase: plan.opticalCoveredInBase || false,
        hasMaternity: plan.hasMaternity || false,
        maternityCoverageLimit: plan.maternityCoverageLimit || "",
        maternityPremium: plan.maternityPremium || "",
        lastExpenseCover: plan.lastExpenseCover || "",
        bedLimit: plan.bedLimit || "",
        isNhifApplicable: plan.isNhifApplicable || false,
        renewalAgeLimit: plan.renewalAgeLimit || "",
        geographicalCoverage: plan.geographicalCoverage || "",
        hasCovidCoverage: plan.hasCovidCoverage || false,
        covidCoverageLimit: plan.covidCoverageLimit || "",
        ...
        <div className="bg-blue-50 px-6 py-4 border-b border-blue-200">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <TbShieldCheck className="h-6 w-6 text-blue-600 mr-3" />
              <div>
            ...
            >
              <TbX className="h-5 w-5 text-blue-600" />
            </button>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mb-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
                <TbInfoCircle className="mr-2 h-5 w-5 text-blue-600" />
                Basic Information
              </h3>
            ...
            <div className="mb-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
                <TbUsers className="mr-2 h-5 w-5 text-blue-600" />
                Age Eligibility
              </h3>
            ...
            <div className="mb-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
                <TbShieldCheck className="mr-2 h-5 w-5 text-blue-600" />
                Coverage Limits
              </h3>
            ...
            <div className="mb-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
                <TbCurrencyDollar className="mr-2 h-5 w-5 text-blue-600" />
                Premium Information
              </h3>
        ...
        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
          <div className="flex justify-end space-x-3">
            ...
            <button
              ...
              disabled={loading}
              className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
            >
              {loading ? (
