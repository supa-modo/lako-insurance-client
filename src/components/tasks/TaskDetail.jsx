        ...
        <div className="space-y-6">
          ...
          <div className="border-t border-neutral-200 pt-4 grid grid-cols-2 gap-4">
            ...
            {task.assignedTo && (
              <div>
                <div className="flex items-center text-sm font-medium text-neutral-500 mb-2">
                  <TbUsers className="mr-2 h-5 w-5" />
                  Assigned To
                </div>
          ...
          <div className="border-t border-neutral-200 pt-4">
            <div className="flex items-center text-sm font-medium text-neutral-500 mb-3">
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                <div className="h-8 w-8 rounded-full bg-neutral-100 flex items-center justify-center mr-3 text-neutral-600">
                  <TbEdit className="h-4 w-4" />
                </div>
                <div>
                  <div className="text-sm text-neutral-900">Task created</div>
