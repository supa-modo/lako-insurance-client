...
const EditApplicationModal = ({ application, onClose, onSave }) => {
  ...
  // Initialize form data with application details
  useEffect(() => {
    if (application) {
      setFormData({
        ...
        universityCollegeSchool: application.universityCollegeSchool || "",
        kraPin: application.kraPin || "",
        nextOfKinName: application.nextOfKinName || "",
        nextOfKinContacts: application.nextOfKinContacts || "",
        beneficiaryName: application.beneficiaryName || "",
        beneficiaryContacts: application.beneficiaryContacts || "",
        previousAccidents: application.previousAccidents || false,
        physicalDisability: application.physicalDisability || false,
        chronicIllness: application.chronicIllness || false,
        medicalHistoryDetails: application.medicalHistoryDetails || "",
        policyStartDate: application.policyStartDate
          ? application.policyStartDate.split("T")[0]
          : "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response && response.success) {
        ...
        setErrors({
          submit: response?.message || "Failed to update application",
        });
      }
    } catch (error) {
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="w-full font-lexend text-[0.93rem] bg-gray-50 text-gray-600 px-4 py-2.5 rounded-lg border border-gray-200">
