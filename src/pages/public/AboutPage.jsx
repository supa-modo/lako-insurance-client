...
const AboutPage = () => {
  ...
  const aboutStructuredData = {
    ...
    "@graph": [
      ...
      {
        "@type": "AboutPage",
        "@id": "https://lako.co.ke/about#aboutpage",
        url: "https://lako.co.ke/about",
        name: "About Lako Insurance Agency",
        description:
          "Learn about Lako Insurance Agency's history, mission, values, and commitment to providing comprehensive insurance solutions in Kenya and East Africa since 2015.",
  ...
  return (
    <>
      <SEOHelmet
        title="About Lako Insurance Agency - Leading Insurance Provider in Kenya Since 2015"
        description="Learn about Lako Insurance Agency's history, mission, and values. We've been providing comprehensive insurance solutions across Kenya and East Africa since 2015. Discover our commitment to excellence, integrity, and client-centered service."
        keywords="about Lako Insurance, insurance agency Kenya history, insurance company background, IRA licensed insurance agency, Kenya insurance provider, East Africa insurance, insurance agency mission, insurance company values"
        canonical="/about"
        ogImage="/lako.png"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 mb-4  text-[0.95rem] md:text-[0.97rem] lg:text-[1.1rem]">
                  ...
                  small office with three dedicated professionals has grown into
                  a trusted insurance partner with a team of experts serving
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-primary-50 rounded-xl p-4 border border-primary-200">
                    ...
                    <p className="text-gray-600 text-sm lg:text-[0.95rem] leading-relaxed">
                      To redefine the insurance experience by delivering
                      tailored, trustworthy, and innovative solutions that
                      safeguard what matters most to our clients.
                    </p>
                  </div>
                  ...
                  <div className="bg-secondary-50 rounded-xl p-4 border border-secondary-200">
                    ...
                    <p className="text-gray-600 text-sm lg:text-[0.95rem] leading-relaxed">
                      ...
                      insurance provider, offering personalized solutions that
                      protect lives, assets, and futures globally.
                    </p>
                  </div>
                </div>
        ...
        <section className="pt-6 bg-white">
          <div className="lg:container mx-auto px-4">
            <div className="text-center md:text-left max-w-4xl mb-6 md:mb-8">
              ...
              >
                What <span className="text-secondary-500">drives us</span>{" "}
                forward
              </motion.h2>
              ...
              >
                ...
                our decisions, shape our culture, and define how we serve our
                clients every day.
              </motion.p>
            </div>
                ...
                <div className="md:col-span-8 p-6 lg:p-10">
                  ...
                  <div className="relative text-base lg:text-[1.1rem]">
                    ...
                    <p className="text-gray-600  mb-4 relative z-10 pl-6">
                      With over a decade of experience in the insurance
                      industry, I've witnessed the ever-evolving needs of our
                      clients. Lako is here to provide safety, reliability, and
                      convenience. Our commitment to you is unwavering, and our
                      promise is simple: To safeguard what's 'Lako' in every way
                      possible. As you explore our services, you'll discover how
                      we turn promises into realities, how we make insurance a
                      partnership, and how, together, we secure a brighter
                      future.
                    </p>
          ...
          <div className="lg:container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-8 md:mb-12">
              ...
              >
                ...
                relationships, offer personalized solutions, and ensure your
        ...
        <section className="pt-16 md:pt-20 bg-gradient-to-r from-primary-800 to-primary-700 relative overflow-hidden">
          ...
          <div className="lg:container mx-auto px-4 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              >
                <span className="text-secondary-500">Numbers</span> that speak
                for themselves
              </motion.h2>
          ...
          <div className="lg:container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8 lg:mb-16">
              ...
              >
                ...
                district. Feel free to visit us during business hours or
