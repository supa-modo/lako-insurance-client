...
const ServiceDetailsPage = () => {
  ...
  // Generate SEO data when service is loaded
  const getSEOData = () => {
    if (!service) return {};

    const serviceTitle = `${service.title} - Lako Insurance Agency Kenya`;
    const serviceDescription =
      service.description +
      " Get competitive quotes and expert guidance from Kenya's trusted insurance agency.";
    const serviceKeywords = `${service.title.toLowerCase()} Kenya, ${service.title.toLowerCase()}, insurance Kenya, ${service.title.toLowerCase()} quotes, ${service.title.toLowerCase()} coverage, Lako Insurance ${service.title.toLowerCase()}`;
    ...
    const serviceStructuredData = createServiceSchema({
      title: service.title,
