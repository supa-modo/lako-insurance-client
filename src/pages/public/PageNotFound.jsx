...
import { TbArrowLeft, TbHome2 } from "react-icons/tb";
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="mb-4 md:mb-8">
          <h1 className="text-7xl md:text-8xl lg:text-9xl font-bold text-gray-300 mb-2 md:mb-4">404</h1>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-[0.8rem] md:text-sm text-gray-500">
            ...
            <a href="contact" className="text-secondary-600 hover:text-secondary-700 underline underline-offset-4 font-medium">
              support team
            </a>
          </p>
        </div>
