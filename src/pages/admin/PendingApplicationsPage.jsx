  ...
  const fetchApplications = useCallback(async () => {
    ...
    try {
      ...
      if (response && response.success) {
        // Filter for pending applications (submitted or under_review)
        const pendingApps = (response.data?.applications || []).filter(
      ...
      <div className="h-[calc(100vh-64px)] flex flex-col overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
              ...
              <p className="text-gray-500 text-sm">
                Applications awaiting review and processing
              </p>
            </div>
            ...
            <div className="bg-white px-6 py-4 rounded-xl border border-gray-200 border-l-4 border-l-yellow-500 shadow-md">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 bg-yellow-100 rounded-lg">
                  <TbEye className="h-6 w-6 text-yellow-600" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white px-6 py-4 rounded-xl border border-gray-200 border-l-4 border-l-purple-500 shadow-md">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {statistics.avgProcessingTime || "3"} days
                  </p>
                </div>
                    ...
                    <tr>
                      ...
                      >
                        <div className="flex flex-col items-center">
                          <TbClock className="h-12 w-12 text-gray-300 mb-3" />
                        ...
                        <td className="py-5 px-4 whitespace-nowrap">
                          <div className="flex flex-col">
                            ...
                            <span className="text-[0.8rem] font-medium text-gray-500">
                              {Math.floor(
                                (new Date() - new Date(application.createdAt)) /
                                  (1000 * 60 * 60 * 24)
                              )}{" "}
                              days ago
                            </span>
        ...
        <div className="bg-white border-t border-gray-200 px-6 py-3">
          <div className="flex flex-wrap justify-between items-center text-sm text-gray-600">
            <div>
              {filteredAndSortedApplications.length} Pending Applications
            </div>
